...
from paddle.incubate.nn.functional import fused_multi_transformer, fused_multi_transformer_sparse_attention
...
class TestFusedMultiTransformerOpSparse(TestFusedMultiTransformerOp):

    def setUp(self):
        super().setUp()
        self.__class__.op_type = "fused_multi_transformer_sparse_attention"
    ...
    def GetFusedMultiTransformerOut(self):
        ...
        # final_out = None
        final_out = fused_multi_transformer_sparse_attention(
            x,
            ln_scales,
            ln_biases,
            qkv_weights,
...
class TestFusedMultiTransformerOpSandWich(TestFusedMultiTransformerOpSparse):
...
class TestFusedMultiTransformerOpSparseAttn(TestFusedMultiTransformerOpSparse):
